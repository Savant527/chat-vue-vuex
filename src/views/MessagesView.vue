...
.messages {
  ...
  header {
    ...
    .people-list {
      @apply flex gap-1;
      .people-item {
        @apply flex justify-center items-center border-4 border-neutral-100 rounded-full;
        img {
  ...
  footer {
    @apply flex p-2;
    textarea {
      @apply w-full px-2 py-2 resize-none bg-zinc-100 text-zinc-800 rounded-tl-md rounded-bl-md focus:outline-none;
    }
    button {
      @apply flex justify-center items-center px-4 bg-zinc-100 text-zinc-800  hover:text-zinc-500 rounded-tr-md rounded-br-md text-2xl;
    }
  }
}
</style>